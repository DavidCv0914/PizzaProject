...
export default function ContextProvider({children}){
  ...
  const [ingredientMenu,setIngredientMenu] = useState("carnes");
  const [typePizzaMenu,setTypePizzaMenu] = useState(true);
  const [sizeSelect,setSizeSelect] = useState("")
  const [sizeSelectSoda,setSizeSelectSoda] = useState("")
  const [sizeSelectSodaType,setSizeSelectSodaType] = useState("")
